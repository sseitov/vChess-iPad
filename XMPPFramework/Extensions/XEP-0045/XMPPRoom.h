...
@property (unsafe_unretained, readonly) id <XMPPRoomStorage> xmppRoomStorage;

@property (unsafe_unretained, readonly) XMPPJID * roomJID;     // E.g. xmpp-development@conference.deusty.com

@property (unsafe_unretained, readonly) XMPPJID * myRoomJID;   // E.g. xmpp-development@conference.deusty.com/robbiehanson
@property (unsafe_unretained, readonly) NSString * myNickname; // E.g. robbiehanson

@property (unsafe_unretained, readonly) NSString *roomSubject;
